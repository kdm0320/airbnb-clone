...
class Room(core_models.TimeStampedModel):
    ...
    host = models.ForeignKey("users.User", related_name="rooms", on_delete=models.CASCADE,null=True,blank=True)
    ...
    def save(self, *args, **kwargs):
        self.city =  self.city.title()#(<- 도시 이름이 두 단어가 있을 수 있으으로) #str.capitalize(self.city)
